const Header = () => {
    return <nav
        ...
        <button type="button" className="btn btn-text max-sm:btn-square sm:hidden me-2" aria-haspopup="dialog"
                aria-expanded="false" aria-controls="logo-sidebar" data-overlay="#logo-sidebar">
        ...
        <div className="navbar-end flex items-center gap-4">
            <div
                ...
                <div className="dropdown-menu dropdown-open:opacity-100 hidden" role="menu"
                    ...
                    <div
                        className="overflow-y-auto overflow-x-auto text-base-content/80 max-h-56 overflow-auto max-md:max-w-60">
                        ...
                        <div className="dropdown-item">
                            ...
                            <div className="w-60">
                                <h6 className="truncate text-base">Martian added moved Charts & Maps task to the
                                    done
                                    board.</h6>
                        ...
                        <div className="dropdown-item">
                            ...
                            <div className="w-60">
                                ...
                                <small className="text-base-content/50 truncate">You have new message from
                                    Natalie</small>
                            </div>
                        </div>
                        <div className="dropdown-item">
                            ...
                            <div className="w-60">
                                ...
                                <small className="text-base-content/50 text-wrap">Your ABC project application has
                                    been
                                    approved.</small>
                            </div>
                        </div>
                        <div className="dropdown-item">
                            ...
                            <div className="w-60">
                                ...
                                <small className="text-base-content/50 text-wrap">Your have new message from
                                    Jane</small>
                            </div>
                        </div>
                        <div className="dropdown-item">
